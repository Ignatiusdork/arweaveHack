...
// This function is to get current pin made by the user on the map
  ...
  // This function is to publish the pin after the all the info on the form has been provided.
  async function publishPin() {
    ...
    const tags = [
      ...
      { name: "App-Name", value: "Hubs" },
      { name: "Protocol", value: "Hubs" },
  ...
  // This function is to get the current location on the map
  ...
  // clear the data after publishing for fresh data input
  function clearData() {
    title = null;
    description = null;
    files = null;
